...
Jemplate.templateMap['body.html'] = function(context) {
    ...
    try {
output += '<div id="logo">\n    <img src="images/jemplate.gif" />\n</div>\n<div id="news_pane">\n    <h3>Recent Jemplate News</h3>\n';
//line 8 "body.html"

// FOREACH 
(function() {
    var list = stash.get('news_list');
    ...
    try {
        while (! done) {
            stash.data['news'] = value;
output += '\n';
//line 7 "body.html"
output += context.process('news_item');
output += '\n';;
...
Jemplate.templateMap['news_item'] = function(context) {
    if (! context) throw('Jemplate function called without context\n');
    var stash = context.stash;
    var output = '';
...
//line 27 "body.html"
output += stash.get(['news', 0, 'title', 0]);
output += '</span><br />\n    <span class="news_time">';
//line 28 "body.html"
output += stash.get(['news', 0, 'time', 0]);
output += '</span><br />\n    <br />\n    <div class="news_story">';
//line 30 "body.html"
output += stash.get(['news', 0, 'story', 0]);
output += '</div>\n</div>\n<hr />\n';
    }
    catch(e) {
        var error = context.set_error(e, output);
