...
output += stash.get(['GLOBAL', 0, 'global_foo', 0]);
output += '\n#2\n';
//line 4 "global-scope-access.html"
output += stash.get(['GLOBAL', 0, 'global_object', 0, 'str', 0]);
output += '\n#3\n';
//line 6 "global-scope-access.html"
output += stash.get(['GLOBAL', 0, 'global_object', 0, 'func_sum', [ 1, 1 ]]);
output += '\n#4\n';
//line 8 "global-scope-access.html"
output += stash.get(['GLOBAL', 0, 'global_multiply', [ 1, 10 ]]);
output += '\n#5\n';
//line 10 "global-scope-access.html"
output += stash.get('global_foo');
output += '\n#6\n';
//line 12 "global-scope-access.html"
output += stash.get(['global_object', 0, 'str', 0]);
output += '\n#7\n';
//line 14 "global-scope-access.html"
output += stash.get(['global_object', 0, 'func_sum', [ 1, 1 ]]);
output += '\n#8\n';
//line 16 "global-scope-access.html"
...
Jemplate.templateMap['global-scope-access2.html'] = function(context) {
    if (! context) throw('Jemplate function called without context\n');
    var stash = context.stash;
    var output = '';
    ...
    try {
output += '#1\n';
//line 3 "global-scope-access2.html"
stash.set('global_foo', 'local_foo');
//line 3 "global-scope-access2.html"
output += stash.get(['GLOBAL', 0, 'global_foo', 0]);

output += '\n#2\n';
//line 7 "global-scope-access2.html"
output += stash.get('global_foo');
output += '\n#3\n';
//line 10 "global-scope-access2.html"
stash.set('local_var', 'foo');
//line 10 "global-scope-access2.html"
output += stash.get(['GLOBAL', 0, 'local_var', 0]);

output += '\n#4\n';
//line 15 "global-scope-access2.html"
stash.set(['GLOBAL', 0, 'new_global_var', 0], 'new_global_var');
//line 15 "global-scope-access2.html"
output += stash.get('new_global_var');

output += '\n#5\n';
//line 19 "global-scope-access2.html"
output += stash.get(['GLOBAL', 0, 'new_global_var', 0]);

output += '\n#6\n';
//line 22 "global-scope-access2.html"
stash.set('new_global_var', 'local_value');
//line 22 "global-scope-access2.html"
output += stash.get('new_global_var');

output += '\n#7\n';
//line 26 "global-scope-access2.html"
output += stash.get(['GLOBAL', 0, 'new_global_var', 0]);

output += '\n#8\n';
//line 29 "global-scope-access2.html"
stash.set('global_foo', 'global_foo2');
//line 29 "global-scope-access2.html"
output += stash.get('global_foo');

output += '\n#9\n';
//line 34 "global-scope-access2.html"
stash.set(['LOCAL', 0, 'global_foo', 0], 'masked');
//line 34 "global-scope-access2.html"
output += stash.get('global_foo');
...
Jemplate.templateMap['global-scope-access3.html'] = function(context) {
    if (! context) throw('Jemplate function called without context\n');
    var stash = context.stash;
    var output = '';
    ...
    try {
output += '#1\n';
//line 3 "global-scope-access3.html"
// RAW
stash.set('global_foo', global_foo);
//line 3 "global-scope-access3.html"
output += stash.get('global_foo');

output += '\n#2\n';
//line 8 "global-scope-access3.html"
// RAW
stash.set('global_object', global_object);
//line 8 "global-scope-access3.html"
output += stash.get(['global_object', 0, 'str', 0]);

output += '\n#3\n';
//line 12 "global-scope-access3.html"
output += stash.get(['global_object', 0, 'func_sum', [ 1, 1 ]]);

output += '\n#4\n';
//line 15 "global-scope-access3.html"
// RAW
stash.set('global_multiply', global_multiply);
//line 15 "global-scope-access3.html"
output += stash.get(['global_multiply', [ 1, 10 ]]);

output += '\n#5\n';
//line 20 "global-scope-access3.html"
stash.set(['global_object', 0, 'str', 0], 'new_str');
//line 20 "global-scope-access3.html"
output += stash.get(['GLOBAL', 0, 'global_object', 0, 'str', 0]);
...
Jemplate.templateMap['global-scope-access4.html'] = function(context) {
    if (! context) throw('Jemplate function called without context\n');
    var stash = context.stash;
    var output = '';
    ...
    try {
output += '#1\n';
//line 3 "global-scope-access4.html"
output += 'function_property';
...
output += '\n';
//line 8 "list.html"
output += stash.get(['a2', 0, 'slice', [ 1, 2 ], 'join', [ '*' ]]);
output += '\n';
//line 9 "list.html"
